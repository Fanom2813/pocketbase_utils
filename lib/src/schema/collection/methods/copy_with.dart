...
code_builder.Method _copyWithMethod(
    String className, Iterable<Field> allFieldsExceptHidden, CollectionType collectionType) {
        ...
        ..statements.addAll([
          code_builder
              ...
              .newInstance([], {
                ...
                for (final field in allFieldsExceptHidden
                    .where((f) => !(collectionType == CollectionType.view ? viewFields : baseFields).contains(f)))
